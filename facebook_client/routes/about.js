...
exports.about = function(req, res) {
	if (req.session.Email == null) {
		...
		mq_client.make_request('about_queue', msg_payload, function(err,
				results) {
			console.log(results);
			if (err) {
				throw err;
