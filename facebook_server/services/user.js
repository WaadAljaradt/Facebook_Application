														...
														.findOne(
																...
																function(err,
																	...
																	console
																			.log(friend);
																	if (!friend
																			|| (friend.request == '0' && friend.accepted == '0')) {
																		console
																				.log("Succes Search User Not friend");
																		res.code = "200";
																		var json = JSON
																				.stringify({
																	...
																	} else if (friend.request == 1
																			&& friend.senderId == userId) {
																		console
																				.log("Succes Search User friend request sent");
																		res.code = "200";
																		var json = JSON
																				.stringify({
																		...
																		console
																				.log("Succes Search User request from user");
																		res.code = "200";
																		var json = JSON
																				.stringify({
																		...
																		fcoll
																				.findOne(
																						...
																						function(
																								...
																								posts) {
																							console
																									.log("Succes Search User is friend");
																							res.code = "200";
																							var json = JSON
																									.stringify({
	...
	mongo.connect(facebookdb, function() {
		...
		coll.findOne(query, function(err, user) {
			if (!user) {
				...
				fcoll.findOne(query, function(err, friend) {
					if (!friend) {
						var fObject = {
							userId_1 : userId,
							userId_2 : friendId,
